...
if __name__ == "__main__":
    ...
    mlp_model = MLP(input_size=2*horizon, h=horizon, scaler_type='robust', max_steps=200, early_stop_patience_steps=3)
    nbeats_model = NBEATS(input_size=2*horizon, h=horizon, scaler_type='robust', max_steps=200, early_stop_patience_steps=3)
    nhits_model = NHITS(input_size=2*horizon, h=horizon, scaler_type='robust', max_steps=200, early_stop_patience_steps=3)
